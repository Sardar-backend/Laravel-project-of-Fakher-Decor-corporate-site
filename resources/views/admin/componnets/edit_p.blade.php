...
<div class="row">
    ...
    <div class="card ">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{route('admin_project.update', ['admin_project'=>$cat->id])}}" enctype="multipart/form-data" method="post">
                @method('PATCH')
                @csrf
                <div class="card-body">
...
<!--
                  ...
                  @endforeach
                    ...
                    <hr>
                        ...
                        <div class="container">
                        <button class="btn btn-sm btn-danger mt-5" type="button" onclick="name()" id="add_project_attribute">ویژگی جدید</button>
...
<script>
    ...
    let y = document.querySelector('#add_project_attribute')
    let id = 1 ;
