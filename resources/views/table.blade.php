...
<!-- Mirrored from mahdghanon.ir/public/table.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 12 Aug 2023 06:34:53 GMT -->
<head>
    <meta charset="UTF-8">
        ...
        <div class="bg-[url('/assets/images/ber.jpg')] bg-no-repeat h-40 md:h-64 relative">
            <div class="flex justify-center">
                <div class="text-sm absolute top-1/4 md:top-1/2">
                    <h2 class="text-3xl font-YekanBakh-ExtraBlack my-4">جدول ریسپانسیو</h2>
                    <div class="breadcrumbs flex justify-center">
                        <ul class="">
                          <li><a>خانه</a></li> 
                          <li>جدول ریسپانسیو</li>
                        </ul>
                    </div>
                  </div>
            </div>
                ...
                <table class="table table-zebra">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th>1</th>
                      <td>یاسمن حیدری</td>
                      <td>برنامه نویس وب</td>
                      <td>آدرس: تهران، خیابان، کوچه، فرعی 2</td>
                    </tr>
                    <!-- row 2 -->
                    <tr>
                      <th>2</th>
